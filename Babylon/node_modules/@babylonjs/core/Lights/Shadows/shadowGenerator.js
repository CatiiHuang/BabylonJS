...
var ShadowGenerator = /** @class */ (function () {
    ...
    ShadowGenerator.prototype._renderSubMeshForShadowMap = function (subMesh, isTransparent) {
        ...
        if (this.isReady(subMesh, hardwareInstancedRendering, isTransparent)) {
            ...
            var drawWrapper = (_b = shadowDepthWrapper === null || shadowDepthWrapper === void 0 ? void 0 : shadowDepthWrapper.getEffect(subMesh, this, this._nameForDrawWrapperCurrent)) !== null && _b !== void 0 ? _b : subMesh._getDrawWrapper(this._nameForDrawWrapperCurrent);
