...
var BaseCameraPointersInput = /** @class */ (function () {
    ...
    BaseCameraPointersInput.prototype.attachControl = function (noPreventDefault) {
        ...
        this._pointerInput = function (p, s) {
            ...
            var ignoreContext = isTouch || _this._usingSafari;
            ...
            else if (srcElement && (p.type === PointerEventTypes.POINTERUP || (p.type === PointerEventTypes.POINTERMOVE && p.event.button === _this._currentActiveButton && _this._currentActiveButton !== -1 && !ignoreContext))) {
                try {
