...
var NativeRenderTargetWrapper = /** @class */ (function (_super) {
    ...
    function NativeRenderTargetWrapper(isMulti, isCube, size, engine, native) {
        var _this = _super.call(this, isMulti, isCube, size, engine) || this;
        _this._framebuffer = null;
        _this._framebufferDepthStencil = null;
        _this._native = native;
        return _this;
    }
...
var NativeEngine = /** @class */ (function (_super) {
    ...
    function NativeEngine(options) {
        ...
        _this._nativeCamera = _native.NativeCamera ? new _native.NativeCamera() : null;
    ...
    NativeEngine.prototype.setState = function (culling, zOffset, force, reverseSide, cullBackFaces, stencil, zOffsetUnits) {
        ...
        // TODO. zOffsetUnits
        this._native.setState(culling, zOffset, (_b = (_a = this.cullBackFaces) !== null && _a !== void 0 ? _a : cullBackFaces) !== null && _b !== void 0 ? _b : true, reverseSide);
    };
    /**
    ...
    NativeEngine.prototype.getZOffset = function () {
        var zOffset = this._native.getZOffset();
    ...
    NativeEngine.prototype.applyStencil = function () {
        this._native.setStencil(this._stencilMask, this._getStencilOpFail(this._stencilOpStencilFail), this._getStencilDepthFail(this._stencilOpDepthFail), this._getStencilDepthPass(this._stencilOpStencilDepthPass), this._getStencilFunc(this._stencilFunc), this._stencilFuncRef);
    };
    /**
    ...
    NativeEngine.prototype.setStencilBuffer = function (enable) {
        ...
        if (enable) {
            ...
            this._native.setStencil(255, this._native.STENCIL_OP_FAIL_S_KEEP, this._native.STENCIL_OP_FAIL_Z_KEEP, this._native.STENCIL_OP_PASS_Z_KEEP, this._native.STENCIL_TEST_ALWAYS, 0);
        }
    };
    /**
 ...
 */
        ...
        if (loader) {
            ...
            var onload_1 = function (data) {
                ...
                _this._native.loadTexture(underlyingResource, data, !noMipmap, invertY, useSRGBBuffer, function () {
                    ...
                    _this._native.setTextureSampling(underlyingResource, filter);
                    if (scene) {
                        scene._removePendingData(texture);
                    }
    ...
    NativeEngine.prototype._createDepthStencilTexture = function (size, options, rtWrapper) {
        ...
        var framebuffer = this._native.createFrameBuffer(texture._hardwareTexture.underlyingResource, width, height, this._native.TEXTURE_FORMAT_RGBA8, false, true, false);
    ...
    NativeEngine.prototype.createImageBitmap = function (image, options) {
        ...
        return new Promise(function (resolve, reject) {
            if (Array.isArray(image)) {
                var arr = image;
                if (arr.length) {
                    var image_1 = _this._native.createImageBitmap(arr[0]);
                    if (image_1) {
                        resolve(image_1);
                        return;
                    }
    ...
    NativeEngine.prototype.createCubeTexture = function (rootUrl, scene, files, noMipmap, onLoad, onError, format, forcedExtension, createPolynomials, lodScale, lodOffset, fallback, loaderOptions, useSRGBBuffer) {
        ...
        if (extension === ".env") {
            var onloaddata_1 = function (data) {
                ...
                _this._native.loadCubeTextureWithMips(texture._hardwareTexture.underlyingResource, imageData, false, useSRGBBuffer, function () {
                    texture.isReady = true;
                    if (onLoad) {
                        onLoad();
                    }
            ...
            Promise.all(reorderedFiles.map(function (file) { return Tools.LoadFileAsync(file).then(function (data) { return new Uint8Array(data); }); })).then(function (data) {
                return new Promise(function (resolve, reject) {
                    _this._native.loadCubeTexture(texture._hardwareTexture.underlyingResource, data, !noMipmap, true, useSRGBBuffer, resolve, reject);
                });
            }).then(function () {
                texture.isReady = true;
                if (onLoad) {
    ...
    NativeEngine.prototype._createHardwareRenderTargetWrapper = function (isMulti, isCube, size) {
        var rtWrapper = new NativeRenderTargetWrapper(isMulti, isCube, size, this, this._native);
    ...
    NativeEngine.prototype.createRenderTargetTexture = function (size, options) {
        ...
        var framebuffer = this._native.createFrameBuffer(texture._hardwareTexture.underlyingResource, width, height, this._getNativeTextureFormat(fullOptions.format, fullOptions.type), fullOptions.generateStencilBuffer ? true : false, fullOptions.generateDepthBuffer, fullOptions.generateMipMaps ? true : false);
    ...
    NativeEngine.prototype.createCanvas = function (width, height) {
        ...
        var canvas = new _native.NativeCanvas();
        canvas.width = width;
    ...
    NativeEngine.prototype.createCanvasImage = function () {
        ...
        var image = new _native.NativeCanvasImage();
        return image;
    };
    /** @hidden */
