    ...
    WebGPUEngine.prototype._endRenderTargetRenderPass = function () {
        ...
        if (this._currentRenderPass) {
            ...
            if (this._snapshotRenderingPlayBundles) {
                (_b = (_a = gpuWrapper._bundleLists) === null || _a === void 0 ? void 0 : _a[gpuWrapper._currentLayer]) === null || _b === void 0 ? void 0 : _b.run(this._currentRenderPass);
                if (this._snapshotRenderingMode === 1) {
                    this._reportDrawCall((_d = (_c = gpuWrapper._bundleLists) === null || _c === void 0 ? void 0 : _c[gpuWrapper._currentLayer]) === null || _d === void 0 ? void 0 : _d.numDrawCalls);
                }
            }
            ...
            if (this.dbgVerboseLogsForFirstFrames) {
                ...
                if (!this._count || this._count < this.dbgVerboseLogsNumFrames) {
                    console.log("frame #" + this._count + " - render target end pass - internalTexture.uniqueId=", (_f = (_e = this._currentRenderTarget) === null || _e === void 0 ? void 0 : _e.texture) === null || _f === void 0 ? void 0 : _f.uniqueId);
                }
            }
            (_g = this._debugPopGroup) === null || _g === void 0 ? void 0 : _g.call(this, 1);
            this._resetCurrentViewport(1);
            this._resetCurrentScissor(1);
            this._resetCurrentStencilRef(1);
            this._resetCurrentColorBlend(1);
