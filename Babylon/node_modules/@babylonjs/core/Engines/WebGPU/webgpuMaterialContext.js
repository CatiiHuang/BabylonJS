...
var WebGPUMaterialContext = /** @class */ (function () {
    ...
    WebGPUMaterialContext.prototype.setSampler = function (name, sampler) {
        ...
        this.isDirty || (this.isDirty = currentHashCode !== samplerCache.hashCode);
    };
    WebGPUMaterialContext.prototype.setTexture = function (name, texture) {
        ...
        this.isDirty || (this.isDirty = currentTextureId !== ((_c = texture === null || texture === void 0 ? void 0 : texture.uniqueId) !== null && _c !== void 0 ? _c : -1));
    };
    WebGPUMaterialContext.prototype.setBuffer = function (name, buffer) {
        var _a;
