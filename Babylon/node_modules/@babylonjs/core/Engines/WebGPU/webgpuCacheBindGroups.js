    ...
    WebGPUCacheBindGroups.prototype.getBindGroups = function (webgpuPipelineContext, materialContext) {
        ...
        if (!cacheIsDisabled) {
            ...
            for (var _i = 0, _l = webgpuPipelineContext.shaderProcessingContext.bufferNames; _i < _l.length; _i++) {
                ...
                var uboId = (_b = (_a = materialContext.buffers[bufferName]) === null || _a === void 0 ? void 0 : _a.uniqueId) !== null && _b !== void 0 ? _b : 0;
        ...
        for (var i = 0; i < webgpuPipelineContext.shaderProcessingContext.bindGroupLayoutEntries.length; i++) {
            ...
            for (var j = 0; j < setDefinition.length; j++) {
                ...
                if (entry.sampler) {
                    ...
                    var dataBuffer = materialContext.buffers[name_1];
                    if (dataBuffer) {
                        ...
                        Logger.Error("Can't find buffer \"" + name_1 + "\". entry=" + JSON.stringify(entry) + ", buffers=" + JSON.stringify(materialContext.buffers), 50);
                    }
                }
            }
