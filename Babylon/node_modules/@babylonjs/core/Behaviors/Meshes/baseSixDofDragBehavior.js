            ...
            if (pointerInfo.type == PointerEventTypes.POINTERDOWN) {
                if (!virtualMeshesInfo.dragging &&
                    ...
                    if (pointerInfo.pickInfo.originMesh) {
                        // Near interaction
                        virtualMeshesInfo.originMesh.lookAt(_this._pointerCamera.globalPosition);
                    }
                    else {
                    ...
                    virtualMeshesInfo.pivotMesh.position.copyFrom(_this._ownerNode.getAbsolutePivotPoint());
                    ...
                    _this._targetDragStart(virtualMeshesInfo.pivotMesh.position, virtualMeshesInfo.pivotMesh.rotationQuaternion, pointerId);
                    _this.onDragStartObservable.notifyObservers({ position: virtualMeshesInfo.pivotMesh.position });
                }
            }
                ...
                if (registeredPointerIndex !== -1 && virtualMeshesInfo.dragging && pointerInfo.pickInfo && pointerInfo.pickInfo.ray) {
                    ...
                    _this._applyZOffset(virtualMeshesInfo.dragMesh, localOriginDragDifference, zDragFactor);
                    _this._applyZOffset(virtualMeshesInfo.pivotMesh, localOriginDragDifference, zDragFactor);
                    ...
                    if (pointerInfo.pickInfo.originMesh) {
                        // Near interaction
                        lookAt.copyFrom(_this._pointerCamera.globalPosition);
                    }
                    else {
                    ...
                    virtualMeshesInfo.pivotMesh.rotationQuaternion.multiplyToRef(_this._tmpQuaternion, _this._tmpQuaternion);
                    virtualMeshesInfo.pivotMesh.position.subtractToRef(virtualMeshesInfo.startingPivotPosition, _this._tmpVector);
