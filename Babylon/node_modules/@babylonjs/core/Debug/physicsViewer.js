...
import { CapsuleBuilder } from '../Meshes/Builders/capsuleBuilder';
/**
...
var PhysicsViewer = /** @class */ (function () {
    ...
    PhysicsViewer.prototype._getDebugCapsuleMesh = function (scene) {
        if (!this._debugCapsuleMesh) {
            this._debugCapsuleMesh = CapsuleBuilder.CreateCapsule('physicsBodyCapsuleViewMesh', { height: 1 }, scene);
