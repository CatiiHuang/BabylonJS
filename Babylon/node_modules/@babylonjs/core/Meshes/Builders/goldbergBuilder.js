...
VertexData.CreateGoldberg = function (options, goldbergData) {
 ...
 */
var GoldbergBuilder = /** @class */ (function () {
    function GoldbergBuilder() {
    }
    /**
     ...
     */
    GoldbergBuilder.CreateGoldberg = function (name, options, scene) {
        ...
        var vertexData = VertexData.CreateGoldberg(options, goldbergData);
    ...
    return GoldbergBuilder;
}());
export { GoldbergBuilder };
/**
...
Mesh.ExtendToGoldberg = function (mesh) {
