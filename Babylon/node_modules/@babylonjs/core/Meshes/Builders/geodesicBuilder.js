 ...
 */
var GeodesicBuilder = /** @class */ (function () {
    function GeodesicBuilder() {
    }
    /**
     ...
     */
    GeodesicBuilder.CreateGeodesic = function (name, options, scene) {
        ...
        var geodesic = PolyhedronBuilder.CreatePolyhedron(name, geoOptions, scene);
        return geodesic;
    };
    return GeodesicBuilder;
}());
export { GeodesicBuilder };
