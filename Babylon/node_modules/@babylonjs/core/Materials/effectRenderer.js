...
var EffectWrapper = /** @class */ (function () {
    ...
    function EffectWrapper(creationOptions) {
        ...
        if (creationOptions.useShaderStore) {
            ...
            this.effect = creationOptions.engine.createEffect(effectCreationOptions.spectorName, creationOptions.attributeNames || ["position"], uniformNames, creationOptions.samplerNames, defines, undefined, creationOptions.onCompiled, undefined, undefined, creationOptions.shaderLanguage);
        }
        else {
