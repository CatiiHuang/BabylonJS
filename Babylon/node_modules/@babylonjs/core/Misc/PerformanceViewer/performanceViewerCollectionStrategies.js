...
var PerfCollectionStrategy = /** @class */ (function () {
    ...
    PerfCollectionStrategy.SpritesStrategy = function () {
        return function (scene) {
            var startTime = PrecisionDate.Now;
            var timeTaken = 0;
            var onBeforeSpritesObserver = scene.onBeforeSpritesRenderingObservable.add(function () {
                startTime = PrecisionDate.Now;
            });
            var onAfterSpritesObserver = scene.onAfterSpritesRenderingObservable.add(function () {
                timeTaken = PrecisionDate.Now - startTime;
            });
            return {
                id: "sprites time",
    ...
    PerfCollectionStrategy.PhysicsStrategy = function () {
        return function (scene) {
            var startTime = PrecisionDate.Now;
            var timeTaken = 0;
            var onBeforePhysicsObserver = scene.onBeforePhysicsObservable.add(function () {
                startTime = PrecisionDate.Now;
            });
            var onAfterPhysicsObserver = scene.onAfterPhysicsObservable.add(function () {
                timeTaken = PrecisionDate.Now - startTime;
            });
            return {
                id: "physics time",
