...
var EnvironmentTextureTools = /** @class */ (function () {
     ...
     * @private
     */
    EnvironmentTextureTools.normalizeEnvInfo = function (info) {
     ...
     */
    EnvironmentTextureTools.CreateEnvTextureAsync = function (texture, options) {
        var _a;
     ...
     * @returns a promise
     */
    EnvironmentTextureTools.UploadLevelsAsync = function (texture, imageData, imageType) {
        var _this = this;
