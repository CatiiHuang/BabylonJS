 ...
 */
var CodeStringParsingTools = /** @class */ (function () {
    function CodeStringParsingTools() {
    }
    /**
     ...
     */
    CodeStringParsingTools.ExtractBetweenMarkers = function (markerOpen, markerClose, block, startIndex) {
     ...
     */
    CodeStringParsingTools.SkipWhitespaces = function (s, index) {
     ...
     */
    CodeStringParsingTools.IsIdentifierChar = function (c) {
     ...
     */
    CodeStringParsingTools.RemoveComments = function (block) {
     ...
     */
    CodeStringParsingTools.FindBackward = function (s, index, c) {
     ...
     */
    CodeStringParsingTools.EscapeRegExp = function (s) {
        return s.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
    };
    return CodeStringParsingTools;
}());
export { CodeStringParsingTools };
